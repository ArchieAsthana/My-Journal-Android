...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            JournalUser journalUser = getJournalUser(username);

            if (journalUser == null) {
                addJournalUser(username);
                journalUser = getJournalUser(username);
            }
            Intent intent = new Intent(this, JournalEntryActivity.class);
            intent.putExtra("JOURNAL_USER", journalUser);
    ...
    public JournalUser getJournalUser(String username) {
        JournalDatabaseHelper dbHelper = JournalDatabaseHelper.getInstance(MainActivity.this);
        return dbHelper.getJournalUser(username);
    }

    public void addJournalUser(String username) {
        JournalDatabaseHelper dbHelper = JournalDatabaseHelper.getInstance(MainActivity.this);
        dbHelper.addJournalUser(username);
    }
